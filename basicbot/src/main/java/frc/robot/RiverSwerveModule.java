...
public class RiverSwerveModule {
  ...
  /**
   * Constructs a SwerveModule with a drive motor, turning motor and hall-effect relative encoders
   * accessed via the SparkMAX controllers.
   *
   * @param driveMotorChannel CAN ID for the drive motor.
   * @param turningMotorChannel CAN ID for the turning motor.
   */
  public SwerveModule( int driveMotorID, int turningMotorID ) {
    m_driveMotor = new CANSparkMax(driveMotorChannel);
    m_turningMotor = new CANSparkMax(turningMotorChannel);
